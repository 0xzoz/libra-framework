...
module ol_framework::test_donor_voice {
  ...
  // use diem_std::debug::print;
    ...
    &signer, carol: &signer) {
      ...
      assert!(community_wallet::is_init(community_wallet_address), 7357004);
      ...
      //verify community wallet can send funds and bypass multi sig
      ol_account::transfer(community, @0x1000c, 10);
      ...
      //verify community wallet can not send funds and bypass multi sig
      ol_account::transfer(community, @0x1000b, 10);
      ...
      assert!(community_wallet_balance_pre_scheduled_epoch == 32, 7357019);
      ...
      assert!(bob_balance_processed_payment == 10999958, 7357020);

      let (_, community_wallet_balance_processed_payment) = ol_account::balance(community_wallet_address);
      assert!(community_wallet_balance_processed_payment == 32, 7357021);
